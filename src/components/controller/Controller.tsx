...
export function Controller() {
  ...
  useEffect(() => {
    ...
    // Omit flatCueIds from deps: it's recreated every render (flatMap), and the tick calls setProgressPct every frame,
    // which would re-run this effect every frame and restart the timer. We read ids via flatCueIdsRef.current in the tick.
  }, [isLive, programCueItemIdx, holdDuration, endOfCueBehavior, fadeOutDur, user?.id, fadeInDur]);
